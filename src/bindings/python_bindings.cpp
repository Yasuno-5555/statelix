...
PYBIND11_MODULE(statelix_core, m) {
    ...
    py::enum_<statelix::GMMType>(panel, "GMMType")
        .value("DIFFERENCE", statelix::GMMType::DIFFERENCE)
        .value("SYSTEM", statelix::GMMType::SYSTEM)
        .export_values();

    py::class_<statelix::DynamicPanelResult>(panel, "DynamicPanelResult")
        .def_readonly("gamma", &statelix::DynamicPanelResult::gamma)
        .def_readonly("gamma_se", &statelix::DynamicPanelResult::gamma_se)
        .def_readonly("beta", &statelix::DynamicPanelResult::beta)
        .def_readonly("coef", &statelix::DynamicPanelResult::coef)
        .def_readonly("std_errors", &statelix::DynamicPanelResult::std_errors)
        .def_readonly("p_values", &statelix::DynamicPanelResult::p_values)
        .def_readonly("sargan_stat", &statelix::DynamicPanelResult::sargan_stat)
        .def_readonly("sargan_pvalue", &statelix::DynamicPanelResult::sargan_pvalue)
        .def_readonly("hansen_stat", &statelix::DynamicPanelResult::hansen_stat)
        .def_readonly("hansen_pvalue", &statelix::DynamicPanelResult::hansen_pvalue)
        .def_readonly("ar1_stat", &statelix::DynamicPanelResult::ar1_stat)
        .def_readonly("ar1_pvalue", &statelix::DynamicPanelResult::ar1_pvalue)
        .def_readonly("ar2_stat", &statelix::DynamicPanelResult::ar2_stat)
        .def_readonly("ar2_pvalue", &statelix::DynamicPanelResult::ar2_pvalue)
        .def_readonly("n_instruments", &statelix::DynamicPanelResult::n_instruments);

    py::class_<statelix::DynamicPanelGMM>(panel, "DynamicPanelGMM")
        .def(py::init<>())
        .def_readwrite("type", &statelix::DynamicPanelGMM::type)
        .def_readwrite("two_step", &statelix::DynamicPanelGMM::two_step)
        .def_readwrite("windmeijer", &statelix::DynamicPanelGMM::windmeijer)
        .def_readwrite("collapse_instruments", &statelix::DynamicPanelGMM::collapse_instruments)
        .def("fit", &statelix::DynamicPanelGMM::fit, 
             py::arg("Y"), py::arg("X"), py::arg("unit_id"), py::arg("time_id"),
             py::arg("lag_dependent")=true);
