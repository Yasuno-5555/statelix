...
PYBIND11_MODULE(statelix_gamma, m) {
    m.doc() = "Gamma regression (GLM for positive continuous data) module";
    
    // GammaLink enum
    py::enum_<statelix::GammaLink>(m, "GammaLink")
        .value("LOG", statelix::GammaLink::LOG)
        .value("INVERSE", statelix::GammaLink::INVERSE)
        .value("IDENTITY", statelix::GammaLink::IDENTITY)
        .export_values();
    
    // GammaResult
    py::class_<statelix::GammaResult>(m, "GammaResult")
        .def_readonly("coef", &statelix::GammaResult::coef, "Regression coefficients")
        .def_readonly("intercept", &statelix::GammaResult::intercept, "Intercept term")
        .def_readonly("phi", &statelix::GammaResult::phi, "Dispersion parameter phi")
        .def_readonly("std_errors", &statelix::GammaResult::std_errors, "Standard errors")
        .def_readonly("z_values", &statelix::GammaResult::z_values, "z-statistics")
        .def_readonly("p_values", &statelix::GammaResult::p_values, "p-values")
        .def_readonly("conf_int", &statelix::GammaResult::conf_int, "Confidence intervals")
        .def_readonly("fitted_values", &statelix::GammaResult::fitted_values, "Fitted values")
        .def_readonly("linear_predictors", &statelix::GammaResult::linear_predictors, "Linear predictors")
        .def_readonly("deviance_residuals", &statelix::GammaResult::deviance_residuals, "Deviance residuals")
        .def_readonly("pearson_residuals", &statelix::GammaResult::pearson_residuals, "Pearson residuals")
        .def_readonly("log_likelihood", &statelix::GammaResult::log_likelihood, "Log-likelihood")
        .def_readonly("deviance", &statelix::GammaResult::deviance, "Deviance")
        .def_readonly("null_deviance", &statelix::GammaResult::null_deviance, "Null deviance")
        .def_readonly("aic", &statelix::GammaResult::aic, "AIC")
        .def_readonly("bic", &statelix::GammaResult::bic, "BIC")
        .def_readonly("pseudo_r_squared", &statelix::GammaResult::pseudo_r_squared, "Pseudo R-squared")
        .def_readonly("vcov", &statelix::GammaResult::vcov, "Variance-covariance matrix")
        .def_readonly("iterations", &statelix::GammaResult::iterations, "Number of iterations")
        .def_readonly("converged", &statelix::GammaResult::converged, "Convergence flag")
        .def_readonly("n_obs", &statelix::GammaResult::n_obs, "Number of observations")
        .def_readonly("n_params", &statelix::GammaResult::n_params, "Number of parameters");
    
    m.def("fit_gamma", &statelix::fit_gamma,
          "Fit Gamma regression using IRLS",
          py::arg("X"), py::arg("y"),
          py::arg("link") = statelix::GammaLink::LOG,
          py::arg("fit_intercept") = true,
          py::arg("max_iter") = 50,
          py::arg("tol") = 1e-8,
          py::arg("conf_level") = 0.95);
    
    m.def("predict_gamma", &statelix::predict_gamma,
          "Make predictions using fitted Gamma model",
